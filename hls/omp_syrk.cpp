...
///////////////////
// Top IP Function: omp_syrk
// Accel. type hash: 6757855513
// Num. instances: 1
// Wrapper version: 13
///////////////////
...
constexpr unsigned int FPGA_OTHER_II = 4;
constexpr int ts = 256;

void omp_syrk_moved(const float A[ts*ts], float B[ts*ts])
{
#pragma HLS inline
...
void omp_syrk_wrapper(hls::stream<ap_uint<64> >& mcxx_inPort, hls::stream<mcxx_outaxis>& mcxx_outPort, ap_uint<256>* mcxx_memport) {
